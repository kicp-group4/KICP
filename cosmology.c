...
/*
//  If you would like to use your own alloc, free, assert, or error reporting, define these macros:
//
// #define ERROR(msg)       ...
// #define ASSERT(exp)      ...
// #define NEWARR(size)     ...
...
/*
//  If you need higher accuracy of returned values, increase this number. This value (200) is good
//  for about single-precision accuracy, for double precision set it to 5000.
*/
#define NDEX 200
...
struct CosmologyInternal
{
  ...
  double aLow;
  double tCodeOffset;
} cosmology_internal_data = { 0, NDEX, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1.0e-2, 0.0 };
